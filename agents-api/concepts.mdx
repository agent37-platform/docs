...
| Concept | What it is |
| --- | --- |
| **Instance** | An isolated, always-on computer that runs your agent. Built from a [template](/agents-api/templates). Persistent until you delete it, and billed for as long as it exists (compute is hourly, prepaid a day at a time). Create one per end user. |

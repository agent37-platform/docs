...
| Concept | What it is |
| --- | --- |
| **Instance** `inst_` | An isolated, always-on computer that runs your agent. Built from a [template](/agents-api/templates) that installs one or more agents (Hermes by default). Persistent until you delete it. Create one per end user. |

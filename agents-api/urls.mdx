...
<Tip>
  You can construct any port's URL from the id and the port number — `https://{instanceId}-{port}.agent37.app` — or just read `url` from the `ports` array.
</Tip>
...
| `6969` | `https://ab12cd34ef-6969.agent37.app` | Mission Control (browser) |
...
```json response
{
  "url": "https://ab12cd34ef-9119.agent37.app/?token=6a2b...e1f0",
  "port": 9119,

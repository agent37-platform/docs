...
- **\$1 free to start.** Your first visit to the dashboard grants a one-time \$1 credit, enough to run your first instance for days. Until your first real top-up, the workspace is capped at one instance.
...
| ----- | --------------- |
| 2 vCPU / 4 GB RAM / 6 GB disk (default) | \$4.94 |
| 4 vCPU / 8 GB RAM / 20 GB disk | \$10.60 |
| 8 vCPU / 16 GB RAM / 40 GB disk | \$21.20 |

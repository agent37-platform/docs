...
<ParamField body="input" type="string" required>
  The message or task. Text only: a plain string, with no attachment, file, or image field. See [Sessions and models](/agents-api/sessions) for how history carries across turns.
</ParamField>

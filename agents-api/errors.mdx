...
| `insufficient_balance` | 402 | The wallet cannot cover a day of compute: at create (one day billed in advance) or at `start` of a `past_due` instance. |
| `instance_limit_reached` | 409 | The workspace is at its instance limit: one instance on the free credit, 25 once you have topped up. |

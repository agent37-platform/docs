...
| `upstream_timeout` | 504 | The instance stopped responding. Turns have no time limit; you only see this when the instance is stuck. Retry, or read the result from its session. |

...
| `tier_limit` | 403 | Create or resize asks for a template or shape your plan does not include. Free workspaces (before your first top-up) run only `agent37-hermes-small` at the 1 vCPU shapes; a top-up unlocks every template and shape. |

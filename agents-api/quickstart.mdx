...
<Steps>
  <Step title="Get a key and fund your wallet">
    ...
    Then top up your workspace wallet at [www.agent37.com/dashboard/cloud/billing](https://www.agent37.com/dashboard/cloud/billing). A one-time $1 credit covers your first instance (the smallest costs $4.94 per month, billed a day at a time), but the workspace is capped at one instance until your first top-up, so add at least $10 to leave room for more instances and managed LLM calls. Top-ups are $5 to $1000.

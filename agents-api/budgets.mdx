...
<Note>
  This endpoint covers managed spend on one instance. For everything the workspace spent, compute included, by day and by instance, use `GET /v1/usage`. See [Billing](/agents-api/billing#read-workspace-usage).
</Note>

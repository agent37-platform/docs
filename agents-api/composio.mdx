...
I want integrations on my own Composio: my API key, my users' connected accounts, my own metering.
Clone https://github.com/agent37-platform/hermes-openclaw-composio and follow the guide's Get started steps; setup needs my COMPOSIO_API_KEY and a Supabase access token (ask me for both).
Done when an agent I create in the kit calls a connected service and the call shows in its Integrations tab.

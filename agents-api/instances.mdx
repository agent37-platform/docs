...
<ResponseField name="image_ref" type="string | null">
  The public source reference for a system template or registry-born workspace template. `null` for a template published by a [cloud build](/agents-api/templates#build-a-template-in-the-cloud). This never exposes Agent37's internal private-mirror path.
</ResponseField>

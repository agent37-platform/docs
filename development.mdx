---
title: 'Development'
description: 'Preview changes locally while you update the Agent 37 docs'
---
...
Follow these steps to preview the Agent 37 docs locally with Mintlify.
...
Each CLI release is associated with a specific Mintlify version. If your local preview does not align with production, update the CLI:
...
Curious about what changed in the latest CLI version? Check the [CLI changelog](https://www.npmjs.com/package/mintlify?activeTab=versions).

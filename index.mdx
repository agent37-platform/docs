...
<Steps>
  <Step title="Get a key and fund your wallet">
    ...
    Then add funds to your workspace wallet at [www.agent37.com/dashboard/cloud/billing](https://www.agent37.com/dashboard/cloud/billing). New workspaces start with a \$1 credit, enough to create an instance; add about \$10 so the agent's managed LLM calls have room to run. [Billing](/agents-api/billing) covers pricing, fleet balance, and top-up rules.

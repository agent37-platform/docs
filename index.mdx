...
![Agent 37 Cloud routes requests from your app to isolated agent instances.](/images/agent37-gateway-flow-with-logo.svg)

Create an instance once, then send tasks to `/v1/responses`. Agent 37 routes each user to their own persistent instance, where the selected agent runs.
